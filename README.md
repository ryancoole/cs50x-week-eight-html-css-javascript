...
This repo contains my solutions for **Week 8** of Harvard's [CS50x](https://pll.harvard.edu/course/cs50-introduction-computer-science) course. The focus this week was on creating **interactive web pages** using HTML, CSS, and JavaScript, with optional use of Bootstrap for styling.
